...
src = cv2.imread("_resources/_images_must/input_image.jpg", cv2.IMREAD_GRAYSCALE)
...
cv2.imwrite("_resources/_outputs/opencv-threshold-example.jpg", dst)
...
cv2.imwrite("_resources/_outputs/opencv-thresh-binary-maxval.jpg", dst1)
cv2.waitKey()
...
cv2.imwrite("_resources/_outputs/opencv-thresh-binary.jpg", dst2)
cv2.waitKey()
...
cv2.imwrite("_resources/_outputs/opencv-thresh-binary-inv.jpg", dst3)
cv2.waitKey()
...
cv2.imwrite("_resources/_outputs/opencv-thresh-trunc.jpg", dst4)
cv2.waitKey()
...
cv2.imwrite("_resources/_outputs/opencv-thresh-tozero.jpg", dst5)
cv2.waitKey()
...
cv2.imwrite("_resources/_outputs/opencv-thresh-to-zero-inv.jpg", dst6)
