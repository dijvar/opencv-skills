...
if __name__ == '__main__':
    ...
    parser.add_argument('--image_dir',  type=str,  help='image directory path',default= "./_resources/_images_must/camera_calibration/")
    ...
    parser.add_argument('--save_file', default= "./_resources/_outputs/camera.yml",type=str, help='YML file to save calibration matrices')
